        ...
        <section id="about" className="py-20 bg-dark-bg text-off-white px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
                ...
                <h3 className="text-3xl font-bold font-sans text-off-white leading-tight">
                    Hi, I'm Ankush Gupta — a Software Developer and final-year B.E. Computer Science & IT student.
                </h3>
                ...
                <div className="space-y-6 text-xl text-gray-300 font-sans leading-relaxed">
                    ...
                    <p>
                        I may not be the best full-stack developer out there in the market, but I'm confident I'm one of the best when it comes to leveraging AI tools effectively. I don't just use AI to generate projects — I use it strategically to optimize my workflow, debug faster, and explore better solutions, working daily with tools like Claude Code, Antigravity, n8n, and Make to automate and accelerate how I build.
                    </p>
                </div>
            </div>
        </section>
