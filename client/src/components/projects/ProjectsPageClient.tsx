...
export default function ProjectsPageClient({ projects }: ProjectsPageClientProps) {
  ...
  return (
    <>
      <section className={`py-20 bg-gradient-to-b ${currentStyle.bg} transition-colors duration-500`}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h1 className={`text-4xl md:text-5xl font-bold ${currentStyle.text} mb-4 transition-colors duration-500`}>
              My Projects
            </h1>
